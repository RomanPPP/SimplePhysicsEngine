...
for (let i = 0; i < 3; i++) {
  const cube = { physics: new RigidBody(new Box(2, 2, 2)), sprite: box };
...
function createRagdoll(pos = [0,0,0]){
  ...
  const positionConstraints = [
      ...
      new JointPositionConstraint(body, rightLeg, [-0.5,-1.2,0], [0,1.2,0],  0.2),
      new JointPositionConstraint(body, leftLeg, [0.5,-1.2,0], [0,1.2,0],  0.2),
  ]
